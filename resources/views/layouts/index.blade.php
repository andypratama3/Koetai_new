...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/admin" class="logo d-flex align-items-center">
        {{-- <img src="{!!asset('Arsha/LOGO KMS VOL2.png')!!}" alt=""> --}}
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{!! asset('assetsAdmin/img/profile-img.jpg')!!}" alt="Profile" class="rounded-circle">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/admin/event">
          <i class="bx bx-book-open"></i><span>Event</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="/admin/sponsor">
          <i class="bi bi-star"></i><span>Sponsor</span>
        </a>
      </li><!-- End Tables Nav -->


      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#shopping-nav" data-bs-toggle="collapse" href="/admin/marchent/">
          <i class="bx bxs-shopping-bag"></i><span>Marchent</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="shopping-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      2023&copy; Copyright <strong><span>Koetai Mahkota Soundline</span></strong>. All Rights Reserved
    </div>
  </footer><!-- End Footer -->
